...
var _user$project$Main$updateContent = F2(
	function (txt, model) {
		return A3(_user$project$Main$Model, model.status, txt, model.posts);
	});
var _user$project$Main$updateStatus = F2(
	function (txt, model) {
		return A3(_user$project$Main$Model, txt, model.content, model.posts);
	});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'Delete':
				return A2(_user$project$Main$removePost, _p0._0, model);
			case 'Text':
				return A2(
			...
			default:
				return _user$project$Main$addPost(
				...
				return A2(
					...
					{ctor: '[]'},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(l.content),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text(l.time),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$Main$emptyModel, view: _user$project$Main$view, update: _user$project$Main$update})();
